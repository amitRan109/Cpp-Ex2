...
Tree Inbar ("Inbar"); 
	...
	.addMother("Rachel", "Becka");
      ...
      CHECK(Amit.relation("Micha")!=string("me"));
      CHECK(Amit.relation("Amit")!=string("mother"));
      CHECK(Amit.relation("Amit")!=string("grandmother"));
      CHECK(Amit.relation("Ofir")!=string("grandfather"));
      CHECK(Amit.relation("Chen")!=string("grandmother"));
